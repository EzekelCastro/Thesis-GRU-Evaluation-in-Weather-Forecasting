...
Streamlit page — Model Evaluation (Model Comparison Pipeline)
"""
...
# Allow imports from the project root when running as a Streamlit page
...
if st.session_state.results:
    ...
    with tab_metrics:
        ...
        st.caption(
            ...
            "t-stat / p-value from a paired t-test (H₀: no systematic bias); "
            "p > 0.05 means predictions are statistically indistinguishable from actuals."
        )

        metric_choice = st.radio(
            "Metric to chart:",
            ["Accuracy (%)", "R2", "MSE", "MAE", "p-value"],
            horizontal=True,
            index=0,
        )
